  ...
  return (
    <PageWrapper>
      <div className="flex flex-col gap-y-9 items-center justify-center my-auto">
        ...
        />
        <Heading
          content="Welcome to the Live Polling System"
          boldTextHeading="Live Polling System"
          para="Please select the role that best describes you to begin using the live
        polling system"
          boldTextPara=""
          align="center"
        />
        <div className="flex justify-between gap-x-8">
          <Card
            selected={selectedCard === "student"}
            onClick={() => setSelectedCard("student")}
            label="I'm a Student"
            content="Lorem Ipsum is simply dummy text of the printing and typesetting industry"
          />
          <Card
            selected={selectedCard === "teacher"}
            onClick={() => setSelectedCard("teacher")}
            label="I'm a Teacher"
