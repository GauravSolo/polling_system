...
function Teacher() {
  ...
  const handleSubmit = async () => {
    try {
      const res = await fetch(`${API_URL}/questions`, {
        ...
        body: JSON.stringify({ question, timer, options }),
      });
  ...
  return (
    <PageWrapper>
      ...
      <div className="flex px-20 py-5 mt-auto justify-end border-t-1 w-full border-[#B6B6B6]">
        <Button label="Ask Question" type="button" onClick={handleSubmit} />
      </div>
    </PageWrapper>
  );
}
