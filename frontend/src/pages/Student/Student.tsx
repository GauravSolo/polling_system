...
function Student() {
  ...
  const registerStudent = async () => {
    ...
    if (data) {
      ...
      navigate("/student/questionaire");
    } else {
      alert("Error on adding student");
    }
  };

  return (
    <PageWrapper>
      <div className="flex flex-col gap-y-9 items-center justify-center my-auto">
        <Button
          icon={
            <svg
              width="15"
        ...
        <Heading
          ...
          para="If you're a student, you'll be able to submit your answers, participate in live polls, and see how your responses compare with your classmates"
          boldTextPara="submit your answers"
          align="center"
        />
        <Input onChange={onChange} value={studentName} />
        <Button label="Continue" type="button" onClick={registerStudent} />
      </div>
    </PageWrapper>
  );
}
