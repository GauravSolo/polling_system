...
const Poll: React.FC<PollProps> = ({
  ...
  useEffect(() => {
    if (!question) return;
    const endTime = new Date(question.timer_end).getTime();
    ...
    <>
      {user == "teacher" ? (
        ...
        <div className="flex items-center">
          <label className={styles.questionLabel}>Question {asked}</label>
          <div className="timer flex items-center ms-6">
            <span>
              <svg
                width="16"
                height="21"
